...
#####__Regional variation in South Korea__ 

(Updated: `r time` EDT)  

---

#####1. Cumulative cases by region 
...
#####2. Cumulateive incidence by region 
```{r,  results='asis', fig.align="left", out.width="800px"}
dtafig<-dtabyregion%>%filter(date==max(date))
...
#####2.1 Cumulateive incidence trend by region 
```{r,  results='asis', fig.align="left", out.width="800px"}
...
#####3. Changes in regional composition over time
```{r,  results='asis', fig.align="left", out.width="800px"}
dtafig<-dtabyregion
...
#####4. Number of new cases by region over time
```{r,  results='asis', fig.align="left", out.width="800px"}
dtafig<-dtabyregion
...
#####6. Case fatality rate by region
```{r,  results='asis', fig.align="left", out.width="800px"}
dtafig<-dtabyregion%>%filter(date==max(date))%>%filter(region!="Airport")
...
#####7. Trends of case fatality rate by region
```{r,  results='asis', fig.align="left", out.width="800px"}
