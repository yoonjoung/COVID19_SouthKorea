...
write.csv(dtanewcasebyday, "KCOVID/dtanewcasebyday.csv")
```
...
write.csv(dtabyage, "KCOVID/dtabyage.csv")
```
...
#export to CSV for the paper 
write.csv(dtabyday, "KCOVID/dtabyday.csv")
```
...
#export to CSV for the paper
write.csv(dtabyregiondetail, "KCOVID/dtabyregiondetail.csv")
...
#export to CSV for the paper 
write.csv(dtabyregion, "KCOVID/dtabyregion.csv")
```
...
fig<-plot_ly(dta, x=dta$date, y=dta$test, 
...
plot_ly(dta, x=dta$date, y=dta$test, 
        type = 'bar', name='All tests', offsetgroup=1, 
        marker=list(color ="#8DB9D9")) %>%
        add_trace(y=dta$newconfirmedcases, name = 'Positive tests', marker=list(color ="#1F77B4"), type = 'bar', offsetgroup=2, yaxis='y2' ) %>%    
        layout(
            title = "Number of tests and confirmed cases by day",
            xaxis = list(title = "Date",  
                         tickfont = list(size=10)),
            yaxis = list(title = "Number of all tests"),
