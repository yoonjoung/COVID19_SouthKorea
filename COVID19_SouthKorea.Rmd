...
#####__Q9. How are different regions affeted in the country?__
```{r}
...
```{r plotbyregionincidence, results='asis', fig.align="left", out.width="800px"}
subplot(fignewcases, figincidencerate, nrows=1) %>%
        layout(  title ="Total number of cases and cumulative incidence rate by province", 
                 showlegend = FALSE )
```
(Note: special cities are included in provinces where they are located. Daegu is included in Gyungbuk province. Seoul and Inchon are included in Gyeonggi province. Busan is included in Gyungnam province.)

```{r plotbyregionmortality, results='asis', fig.align="left", out.width="800px"}
dtafig<-dtabyregion%>%
